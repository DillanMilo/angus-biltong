  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        const groceries = allProducts.filter((product: Product) => {
          const name = product.name.toLowerCase();
          // Exclude meat products and sausages
        ...
        console.log("Filtered groceries:", groceries);
    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        <h2 className="text-3xl font-bold mb-6 capitalize text-center playfair underline">
          Groceries ({products.length} items)
        </h2>
